...
# [Border-radius Previewer](https://geisson.github.io/border-radius-previewer/)
...
Font: [App Ideas: Border-radius Previewer  ](https://github.com/geisson/app-ideas/blob/master/Projects/1-Beginner/Border-Radius-Previewer.md)
